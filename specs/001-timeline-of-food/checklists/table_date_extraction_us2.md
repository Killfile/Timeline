...
- [ ] **Description**: "Time range of several sites with archaeological evidence..."
- [ ] **Table column 1**: "2500–1500 BCE"
- [ ] **Expected start_year**: -2500
- [ ] **Expected end_year**: -1500
- [ ] **Expected is_bc_start**: true
- [ ] **Expected is_bc_end**: true
- [ ] **Expected span_match_notes**: Should indicate YearRangeParser with BC/BCE handling
- [ ] **Status**: ⏳ BLOCKED - Requires YearRangeParser BC/BCE fix (T027a)

### Case 5: Mixed Range (Depends on T027a)
- [ ] **Description**: "Archaeological evidence of early grains..."
- [ ] **Table column 1**: "4000–2000 BCE"
- [ ] **Expected start_year**: -4000
- [ ] **Expected end_year**: -2000
- [ ] **Expected span_match_notes**: Should indicate YearRangeParser match
- [ ] **Status**: ⏳ BLOCKED - Requires YearRangeParser BC/BCE fix (T027a)

## Implementation Requirements (User Story 2)

### For T027a (YearRangeParser BC/BCE Fix):
- [ ] When BC/BCE marker appears on second part of range, apply to first part
- [ ] Example: "2500–1500 BCE" → both years are BC
- [ ] Update YearRangeParser.parse() to detect trailing BC/BCE and apply retroactively
- [ ] Add test cases for all BC/BCE range combinations
...
- [ ] Unit tests for YearRangeParser BC/BCE handling (T027a)
...
- [ ] T027a: YearRangeParser BC/BCE bug fixed
