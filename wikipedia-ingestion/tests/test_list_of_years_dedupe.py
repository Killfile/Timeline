...
def test_parse_span_from_bullet_bc_range():
    span = SpanParser.parse_span_from_bullet("500 BC – 490 BC — Something happens", 500, assume_is_bc=True)
...
def test_parse_span_from_bullet_ad_range():
    span = SpanParser.parse_span_from_bullet("1991–1993 — Something happens", 1991, assume_is_bc=False)
    assert span is not None
